return {
	...
	["jc-doyle/cmp-pandoc-references"] = {
		after = "nvim-cmp",
		config = function()
			require("user.plugins.cmp-pandoc-references")
		end,
	},
	...
	["nvim-telescope/telescope-bibtex.nvim"] = {
		...
		config = function()
			require("user.plugins.telescope-bibtex")
		end,
	},
	...
	["p00f/clangd_extensions.nvim"] = {
		after = "mason-lspconfig.nvim",
		config = function()
			require("user.plugins.clangd_extensions")
		end,
	},
	...
	["mg979/vim-visual-multi"] = {
		opt = true,
		setup = function()
			table.insert(astronvim.file_plugins, "vim-visual-multi")
		end,
	},
