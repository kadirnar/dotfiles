#+TITLE: msa's Doom Emacs Config
#+AUTHOR: Mert Sefa AKGUN (msa)
#+DESCRIPTION: msa's personal Doom Emacs config.
...
* COPILOT
Copilot is AI based code completion & suggestion service.
#+begin_src emacs-lisp
...
* HYDRA
Hydra configurations for escaping lot of key sequences.
